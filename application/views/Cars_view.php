            ...
            <li class="list-group-item">
              <div class="media align-items-lg-center flex-column flex-lg-row p-3">
                <div class="media-body order-2 order-lg-1">
                  ...
                  <p class="font-italic text-muted mb-0 small"> <?php echo $row->COLORS; ?>, <?php echo $row->DOORS; ?>, <?php echo $row->TYPE; ?>.</p>
                  <div class="d-flex align-items-center justify-content-between mt-1">
                    <h6 class="font-weight-bold my-2"> <?php echo $row->PRICE; ?></h6>
                    <button type="button" class="btn btn-primary d-flex justify-content-end">Primary</button>

                  </div>
                </div><img src="<?php echo base_url($row->PHOTO) ?>">
              </div>
            </li>
          </ul>
        </div>
