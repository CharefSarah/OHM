...
<head>
    ...
    <title> OHM - Mentions Légales</title>
</head>
...
<body>
    ...
    <p>
        ...
        <br>
        <br>
        Ce site est édité par la société <span class="wtLegalMentionsPropName">OHM</span>.
        <br>
        Siège social : <span class="wtLegalMentionsPropName">OHM</span>, 16
        Boulevard Amiral Mouchez, 76600
        Le Havre, France.s<br>
        Capital social : XXXXX euros<br>
        Téléphone : +33 (0)2 35 24 12 45<br>
        <br>
        Responsable de la rédaction : CHAREF Sarah<br>
        <br>
        Développement, hébergement : VISUAL STUDIO CODE, CODEIGNITOR, NGROK <br><br>
    </p>
    <div class="text-center">
        ...
        société
        <span class="wtLegalMentionsPropName">OHM</span>.<br>
        <br>
        Elles ne font l'objet d'aucune cession à des tiers. <span class="wtLegalMentionsPropName">OHM</span> traite les informations qui vous
        concernent
        avec
        ...
        propriété
        de
        la société OHM, il est protégé par les lois en vigueur de la législation française sur la propriété
        intellectuelle.<br>
        <br>
        ...
        utiliser
        ce
        site. OHM ne saurait être tenu responsable des éléments en dehors de son contrôle et des dommages
        qui
        ...
        <br>
        <span class="wtLegalMentionsPropName">OHM</span> s'attache à transmettre des informations
        ...
        la
        responsabilité de OHM.<br>
        De même que la société <span class="wtLegalMentionsPropName">OHM</span> ne pourra en aucune façon
